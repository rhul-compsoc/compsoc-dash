...
export const GoodNotification: React.FC<Params> = ({ message, position }) => {
  return (
    <div
      id="toast-success"
      className={`${position} flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`}
      role="alert"
    >
      <div
...
export const BadNotification: React.FC<Params> = ({ message, position }) => {
  return (
    <div
      id="toast-danger"
      className={`${position} flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`}
...
export const WarnNotification: React.FC<Params> = ({ message, position }) => {
  return (
    <div
			id="toast-warning"
			className={`${position} flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`}
			role="alert"
		>
      <div
